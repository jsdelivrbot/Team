...
abstract class Place
{
    ...
    {
        return self::add($place, $order, 'content',
            function ($content, $params, $engine) use ($new_content, $position) {
    ...
    {
        return self::add($place, $order, 'content',
            function ($content, $params, $engine) use ($file_with_content, $position) {
                $new_content = '';
    ...
    public static function widget(string $place, $widget_name, $_options = [], $order = 40, $position = 'end')
    {
        ...
        $options = $_options;
        return self::add($place, $order, 'widget',
            function ($content, $params, $engine) use ($widget_name, $options, $cache_id, $position) {
    ...
    {
        return self::add($place, $order, 'wrapper',
            function ($content, $params, $engine) use ($wrapper_start, $wrapper_end) {
