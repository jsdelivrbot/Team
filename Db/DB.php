...
class DB
{
    ...
    public function connect($conname = null)
    {
        ...
        try {
            ...
            \Team::system("ERROR: Problem with connection to the database. {$e->getMessage()}",
                '\Team\System\database\Connection');
        }
        return null;
    }
    ...
    protected function registerSQL($_sql, $_values)
    {
        ...
        self::$lastQuery = [
            'sql' => $_sql,
            'full_sql' => $this->reverseSQL($_sql, $_values),
            'data' => $_values,
            'rows' => $this->rows,
    ...
    {
        return isset(self::$error[0]) && '0000' != self::$error[0];
    }
     ...
     */
    public function quote($_string)
    {
        return $this->server->quote($_string);
    }
