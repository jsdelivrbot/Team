...
class Date
{
    ...
    public static function getWithRealFormat($format = null, $timestamp = null)
    {
        ...
        switch ($format) {
            case 'i18n':
                $format = self::getWithRealFormat(\Team\System\Context::get('DATE_I18N', 'date', '\Team\System\Date'),
                    $timestamp);
                break;
            case 'long-i18n':
                $format = self::getWithRealFormat(\Team\System\Context::get('LONG_DATE_I18N', 'datetime',
                    '\Team\System\Date'), $timestamp);
                break;
            case 'timestamp':
                $format = '%s';
                break;
    ...
    {
        return $minutes * self::A_MINUTE;
    }

    /** Hours in seconds  */
    public function hours($hours = 1)
    {
        return $hours * self::AN_HOUR;
    }

    /** Weeks in seconds  */
    public function weeks($weeks = 1)
    {
        return $weeks * self::A_WEEK;
    }

    /** Months in seconds  */
    public function months($months = 1)
    {
        return $months * self::A_MONTH;
    }

    /** Years in seconds  */
    public function years($years = 1)
    {
        return $years * self::A_YEAR;
    }
