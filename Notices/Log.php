...
class Log
{
     ...
     */
    static function _option_vars()
    {
        $_vars = get_defined_vars();
        return $_vars["user"];
    }

    static function _option_functions()
    {
        $_funcs = get_defined_functions();
        return $_funcs["user"];
    }

    static function _option_constants()
    {
        $_const = get_defined_constants(true);
        return $_const["user"];
    }

    static function _option_file()
    {
        return preg_replace("/.+\//i", "", self::$_backtrace[1]['file']);
    }

    static function _option_pathfile()
    {
        return self::$_backtrace[1]['file'];
    }

    static function _option_line()
    {
        return self::$_backtrace[1]['line'];
    }

    static function _option_function()
    {
        return self::$_backtrace[1]['function'];
    }

    static function _option_object()
    {
        return self::$_backtrace[1]['object'];
    }

    static function _option_type()
    {
        return self::$_backtrace[1]['type'];
    }

    static function _option_args()
    {
        return self::$_backtrace[1]['args'];
    }

    static function _option_date($_format = "Y-m-d")
    {
        return date($_format);
    }

    static function _option_time($_format = "H:i:s")
    {
        return date($_format);
    }

    static function _option_get()
    {
        return print_r($_GET, true);
    }

    static function _option_post()
    {
        return print_r($_POST, true);
    }

    static function _option_files()
    {
        return print_r($_FILES, true);
    }

    static function _option_session()
    {
        return print_r($_SESSION, true);
    }

    static function _option_classes()
    {
        return print_r(get_declared_classes(), true);
    }

    static function _option_color($_color = "reset")
    {
        return \Team\Notices\Log::$_colors[$_color];
    }

    static function _option_break($_num = 1)
    {
        return str_pad(" ", $_num + 1, "\n\t\r");
    }

    static function _option_split($_char = "*")
    {
        return "\n\t\r" . str_pad(" ", 80, $_char) . "\n\t\r";
    }
